...
<input class="modal-state" id="modal-1d" type="checkbox" />
<div class="modal">
...
<!-- End of bare knuckle moves -->
<!-- Start of FireArms moves -->
<!-- Luce and Ombra -->
...
<div class="modal">
   ...
   <div class="modal__inner">
      ...
      <ul>
         ...
         <li>DT enables you to go Full-Auto by simply holding <img src="{{asset('images\Inputs\Square.png')}}"/></li>
      </ul>
   </td>
</table>
      <table id="Marathon">
