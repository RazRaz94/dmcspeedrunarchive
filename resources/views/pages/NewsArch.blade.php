...
<div id = "content">
    <div id ="left">
        <h1>News Archive</h1>
        <dl class="CF2">
        <b>At the moment this is work in progress page due to gathering the datas from our previous events. You can see all of our previous work by scrolling through
