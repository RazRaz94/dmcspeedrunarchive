        ...
        <table class="CF2">
            ...
            <fieldset>
                <legend>Is it faster to bait Skewer and jump on and kill <a href="https://devilmaycry.fandom.com/wiki/Shadow" target="_blank">Shadow </a>
                    ...
                    <p>{{"It's always better to just unload with DT. Shadow can also show his core instantly sometimes with a rare RNG. In Dante Must Die, it's better to bait
                Skewer instead."}}</p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p>{{"When the first scissor approaches you with its attack pattern don't do long jump cancel on it. Instead, do a quick one with helm breaker.
                ...
                but if you want a double hit rng pray you can wall jump. You can still try quick helm breaker for both still but the first one should always be the quick one."}}</p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p>{{"Yes, the reason why quick shoot being done sometimes is due to the player getting extremely lucky blue spawns."}}</p>
            </fieldset>
            ...
            <fieldset>
                ...
                <p>{{"Nightmare core health is determined by how many times it is hit. It starts blue, then goes green, then red and when it is red it takes significantly decreased damage.
                If you need to put extra damage on a scuffed one cycle Nightmare, attack the core on top so you don't do extra damage to the core in the rear."}}</p>
            </fieldset>

            <fieldset><legend>Can I do Ifrit skip without Air Hike ?</legend>
                <p>  {{"Yes you can, but it's very important to have air hike for the second encounter against"}}
                <a href="https://devilmaycry.fandom.com/wiki/Phantom" target="_blank">Phantom</a>.</p>
            </fieldset>

            <fieldset><legend>Is the room at the end of mission 9 random ?</legend>
                <p> {{"It's not random. From start to finish, you should be shooting your grenade launcher twice to take out the first two groups,
                ...
                in the middle of the room and when each one of them hits the ground after spawning, shoot."}}</p>
            </fieldset>
            ...
            <fieldset><legend><a href="https://devilmaycry.fandom.com/wiki/Griffon" target="_blank">Griffon</a> in Mission 15 is not getting hit at all. What is going on ?</legend>
                <p> {{"After Holy Water, walk to the side of the arena that he is on and roll back/forth with grenades
                if you're not hitting him you can jump backwards and shoot nades."}}</p>
            </fieldset>
    </div>
